...
export const PublicMenu: React.FC = () => {
  ...
  return (
    ...
    <div
      className="min-h-screen relative overflow-hidden transform "
      style={{
    ...
    >
      ...
      <header className="sticky top-0 z-50 relative "> {/* DF: SE QUITÓ EL BLUR */}
        <div className="w-full mx-auto px-5 py-5"> {/* DF: SE REDUJO EL PADDING PARA QUE QUEDE MAS DELGADO */}
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 flex-1 justify-end max-w-xs">
              ...
              <button
                ...
                className=" flex items-center gap-2 p-3 rounded-lg transition-all hover:opacity-90 shadow-lg"
                style={{
                  backgroundColor: (() => {
                    const now = new Date();
      ...
      {/* FLOATING FOOTER BAR */}
      <div
        className="sticky bottom-1 left-4 right-4 shadow-lg z-40 rounded-xl p-1 " /* se le agregar este codigo para los bordes redondeados y padding a los lados*/
