  ...
  return (
    ...
    >
      ...
      {featuredProducts.length > 0 && (
        <section className="max-w-7xl mx-auto px-20 py-10 relative z-30">
      ...
      <main className="max-w-7xl mx-auto px-4 py-4 pb-24 relative z-10" id="products-section">
        ...
        {filteredProducts.length === 0 ? (
          ...
          <div className={
            viewMode === 'list' ? 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2' :
            viewMode === 'grid' ? 'grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2' :
            'space-y-6'
          }>
