...
export const PublicMenu: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <svg
        className="absolute w-[400px] h-[400px] opacity-80 pointer-events-none sm:top-20 right-0 sm:right-0 sm:translate-x-[25%] sm:-translate-y-[25%] top-auto bottom-0 left-1/2 -translate-x-1/2 translate-y-0"
        viewBox="0 0 253 272"
        xmlns="http://www.w3.org/2000/svg"
        style={{
