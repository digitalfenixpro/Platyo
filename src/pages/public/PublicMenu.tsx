...
export const PublicMenu: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <svg
        className="absolute top-20 right-0 w-[400px] h-[400px] opacity-80 pointer-events-none"
        viewBox="0 0 253 272"
        xmlns="http://www.w3.org/2000/svg"
        style={{
              ...
              <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
                {featuredProducts.map((product, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="relative flex flex-col items-center bg-white rounded-2xl shadow-md p-4 w-64 ">
                        <img
